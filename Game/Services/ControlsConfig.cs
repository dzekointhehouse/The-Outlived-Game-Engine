...
//
//            var gamePadUpPreesed = gamePadState.DPad.Up == ButtonState.Pressed && gameManager.OldGamepadState.IsButtonUp(Buttons.DPadUp);
//            var keyboardUpPressed = newState.IsKeyDown(Keys.Up) && gameManager.OldKeyboardState.IsKeyUp(Keys.Up);
//            if (gamePadUpPreesed || keyboardUpPressed)
//            {
...
//
//            }
//            var gamePadDownPressed = gamePadState.DPad.Down == ButtonState.Pressed && gameManager.OldGamepadState.IsButtonUp(Buttons.DPadDown);
//            var keyboardDownPressed = newState.IsKeyDown(Keys.Down) && gameManager.OldKeyboardState.IsKeyUp(Keys.Down);
//            if (gamePadDownPressed || keyboardDownPressed)
//            {
//                gameManager.OldKeyboardState = newState;
//                gameManager.OldGamepadState = gamePadState;
//
